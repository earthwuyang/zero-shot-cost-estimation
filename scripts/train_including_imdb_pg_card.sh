...
python train.py  --train_model \
 ...
 --experiment_desc "train_including_imdb_pg_card" \
 --filename_model imdb_1  \
 --target ../zero-shot-data/evaluation/train_including_imdb_pg_card  \
 --hyperparameter_path setup/tuned_hyperparameters/tune_est_best_config.json  \
 --max_epoch_tuples 100000  \
 --loss_class_name QLoss   \
 --device cuda:0  \
 --num_workers 16  \
 --database postgres  --seed 0  --workload_runs ../zero-shot-data/runs/deepdb_augmented/airline/index_workload_100k_s2_c8220.json \
